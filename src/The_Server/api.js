...
const glcStatus = ctx =>{
    ...
    ctx.response.body = JSON.stringify(
        {"code":200,"message":"成功","data":[{"jgjj":"顶山运营部","intact":"0","px":3,"glcId":"10"},{"jgjj":"500水库运营部","intact":"100","px":5,"glcId":"9"},{"jgjj":"635枢纽运营部","intact":"0","px":6,"glcId":"4"},{"jgjj":"三个泉运营部","intact":"0","px":7,"glcId":"11"},{"jgjj":"布尔津水利枢纽运营部","intact":"1","px":37,"glcId":"35"},{"jgjj":"喀腊塑克水利枢纽运营部","intact":"98","px":38,"glcId":"26"}]}
    )
}

const glcStatusTo = ctx =>{
    ctx.response.type = 'JSON';
            ...
            "data":[
                {
                    "dataTime":"2024-11-04",
                    "dataList":[
                        {"jgjj":"顶山运营部","intact":"0","px":3,"glcId":"10"},
                        {"jgjj":"500水库运营部","intact":"100","px":5,"glcId":"9"},
                        {"jgjj":"635枢纽运营部","intact":"0","px":6,"glcId":"4"},
                        {"jgjj":"三个泉运营部","intact":"0","px":7,"glcId":"11"},
                        {"jgjj":"布尔津水利枢纽运营部","intact":"1","px":37,"glcId":"35"},
                        {"jgjj":"喀腊塑克水利枢纽运营部","intact":"98","px":38,"glcId":"26"}
                    ]
                },{
                    "dataTime":"2024-11-05",
                    "dataList":[
...
app.use(route.get('/glcStatus', glcStatus));
app.use(route.get('/glcStatusTo', glcStatusTo));
...
app.use(async function pageNotFound(ctx) {
  ...
  switch (ctx.accepts('html', 'json')) {
    case 'html':
      ctx.type = 'html';
      ctx.body = '<p>请求的是 html，但是 Page Not Found</p>';
      break;
    case 'json':
      ctx.body = {
        message: '请求的是 json，但是 Page Not Found'
      };
      break;
    default:
      ctx.type = 'text';
